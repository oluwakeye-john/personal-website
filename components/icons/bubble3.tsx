...
const Bubble3 = ({ onDone }: IBubble) => {
  ...
  const interval = useInterval(() => {
    ...
    setCount(newCount);
    if (waterRef.current) {
      waterRef.current.style.transform =
        "translate(0" + "," + (100 - newCount) + "%)";
    }
  }, 50);
...
const boxColor = "#E5FBF4";
const waterFColor = "#4CE2B2";
